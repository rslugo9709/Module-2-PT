...
function buildToDo(todo, index) {
  ...
  //el append hace que el nodo hijo herede las caracteristicas del nodo padre
...
function buildToDos(toDos) {
  ...
  /*
  let toDo = [];
  toDo = toDos.map(function(todo, index){ //primer parametro 
...
addButton.addEventListener("click", addToDo); //se le pasa la funcion, no la invocacion
